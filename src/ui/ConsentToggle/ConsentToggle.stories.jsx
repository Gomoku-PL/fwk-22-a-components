...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: 'A reusable consent toggle component with clear states for granting or withdrawing consent for specific processing purposes.'
      }
    }
  },
  argTypes: {
...
export const MultiplePurposes = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example showing multiple consent toggles for different purposes'
      }
    }
  }
};
